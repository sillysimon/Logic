...
section, we implement $\Sigma$-structures in \textsl{TypeScript}. This helps to illustrate the concept. As a
...
\item Then, we discuss how the formulas of group theory are represented in \textsl{TypeScript}.
\item Next, we define a $\Sigma$-structure in which the formulas of group theory are valid.
\item Finally, we show how to evaluate formulas from first-order logic in \textsl{TypeScript}.
\end{enumerate}
...
\subsection{Representation of Formulas in \textsl{TypeScript}}
In the last section, we have defined the signature $\Sigma_G$ of
group theory as follows:
\\[0.2cm]
\hspace*{1.3cm}
$\Sigma_G = 
   \bigl\langle \{x,y,z\},\; \{\mathrm{e},\circ\},\; \{=\},\; \{ \mathrm{e} \mapsto 0, \circ \mapsto 2, =\;
   \mapsto 2 \} \bigr\rangle 
$.
\\[0.2cm]
...
\subsection{Representation of $\Sigma$-Structures in \textsl{TypeScript}}
...
consists of the set $\{ 0, 1 \}$. In \textsl{TypeScript}, we can 
...
\item In line 2, we define the interpretation of the zero-arity function symbol $\mytt{E}$
      as the \textsl{TypeScript} dictionary that maps the empty tuple to the number $0$.
\item In line 3, we define a function $\mytt{Product}$ as a \textsl{TypeScript} dictionary.  We have
      \\[0.2cm]
      \hspace*{1.3cm}
...
$t$ is represented in \textsl{TypeScript} as a nested tuple.
\begin{enumerate}
...
is represented in TypeScript as a tuple of the form
\\[0.2cm]
\hspace*{1.3cm}
$a = (p, t_1,\cdots,t_n)$.
\\[0.2cm]
...
In the evaluation of a universal quantifier, we can take advantage of the fact that the \textsl{TypeScript} language
...
\\[0.2cm]
\hspace*{0.0cm}
\href{https://github.com/karlstroetmann/Logic/blob/master/TypeScript/Chapter-5/01-FOL-Evaluation.ipynb}{\mytt{github.com/karlstroetmann/Logic/blob/master/TypeScript/Chapter-5/01-FOL-Evaluation.ipynb}}
\\[0.2cm]
...
then be represented in \textsl{TypeScript} as the dictionary 
\\[0.2cm]
\hspace*{1.3cm}
...
\item As we need to determine the variables occurring in a given constraint, we import the module
      ...
      a \textsl{TypeScript} expression $e$.  This expression is parsed and the resulting syntax tree is returned.
\item The function $\mytt{collect\_variables}(\mytt{expr})$ takes a \textsl{TypeScript} expression as its input.
...
\item The procedure $\mytt{solve}$ takes a constraint satisfaction problem $\mytt{CSP}$ as input and tries
      ...
      \item Next, for every constraint $\mytt{f}$ of the given $\mytt{CSP}$, we compute the set of variables that
            ...
            because we assume that any other \textsl{TypeScript} variable occurring in a constraint $f$ has already
...
\\[0.2cm]
\hspace*{1.3cm}
\href{https://github.com/karlstroetmann/Logic/blob/master/TypeScript/Chapter-4/Prince-Tiger.ipynb}{\texttt{github.com/karlstroetmann/Logic/blob/master/TypeScript/Chapter-5/Zebra-CSP.ipynb}}
\\[0.2cm]
...
\\[0.2cm]
\hspace*{0.3cm}
\href{https://github.com/karlstroetmann/Logic/blob/master/TypeScript/Chapter-5/Crypto-Arithmetic.ipynb}{\texttt{github.com/karlstroetmann/Logic/blob/master/TypeScript/Chapter-5/Crypto-Arithmetic.ipynb}}
\\[0.2cm]
...
represented as a symbolic transition system in \textsl{TypeScript}.  In the function \texttt{transition} 
we use the following convention: Since variables cannot be primed in
\textsl{TypeScript} we append the character $\alpha$ to the names of the original
...
\\[0.2cm]
\hspace*{-0.5cm}
\href{https://github.com/karlstroetmann/Logic/blob/master/TypeScript/Chapter-5/Wolf-Goat-Cabbage-STS.ipynb}{\texttt{github.com/karlstroetmann/Logic/blob/master/TypeScript/Chapter-5/Wolf-Goat-Cabbage-STS.ipynb}}
\eox
...
interface of Z3.
\begin{enumerate}
\item In line 1 we import the module \texttt{z3} so that we can use the TypeScript \textsc{Api} of Z3.
...
\\[0.2cm]
\hspace*{0.0cm}
\href{https://github.com/karlstroetmann/Logic/blob/master/TypeScript/Chapter-5/Parrot-and-Penguin.ipynb}{\texttt{github.com/karlstroetmann/Logic/blob/master/TypeScript/Chapter-5/Parrot-and-Penguin.ipynb}}
\eox
...
\\[0.2cm]
\hspace*{0.8cm}
\href{https://github.com/karlstroetmann/Logic/blob/master/TypeScript/Chapter-5/Train-Z3.ipynb}{\texttt{github.com/karlstroetmann/Logic/blob/master/TypeScript/Chapter-5/Train-Z3.ipynb}}
\eox
...
\\[0.2cm]
\hspace*{0.0cm}
\href{https://github.com/karlstroetmann/Logic/blob/master/TypeScript/Chapter-5/Sudoku-Z3.ipynb}{https://github.com/karlstroetmann/Logic/blob/master/TypeScript/Chapter-5/Sudoku-Z3.ipynb}.
    \eox
...
\\[0.2cm]
\hspace*{0.0cm}
\href{https://github.com/karlstroetmann/Logic/blob/master/TypeScript/Chapter-5/Japanese-Z3.ipynb}{https://github.com/karlstroetmann/Logic/blob/master/TypeScript/Chapter-5/Japanese-Z3.ipynb}.
\eox
...
\\[0.2cm]
\hspace*{0.0cm}
\href{https://github.com/karlstroetmann/Logic/blob/master/TypeScript/Chapter-5/Bridge-Torch.ipynb}{https://github.com/karlstroetmann/Logic/blob/master/TypeScript/Chapter-5/Bridge-Torch.ipynb}.
\eox
