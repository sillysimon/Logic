...
{
    const diffM = Ma.sub(Mb);            // Ma - Mb
    const diffC = Ca.sub(Cb);            // Ca - Cb
    const totalDiff = diffM.add(diffC);  // Ma - Mb + Ma - Mb
            // B = 1 → 1 ≤ Ma - Mb + Ma - Mb ≤ 2 ∧ Mb ≤ Ma ∧ Cb ≤ Ca
   return Z3.Implies(Ba.eq(1),
                     Z3.And(totalDiff.ge(1), totalDiff.le(2), Mb.le(Ma), Cb.le(Ca)));
}
